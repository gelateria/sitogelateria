...
;(function($) {
	...
	$.DivasCookies = function(options) {
		var defaults = {
					bannerText				: "Questo sito utilizza i cookies, se clicchi ok o scorri la pagina accetterai il loro utilizzo",		// text for the Divas Cookies banner
					...
					declineButtonText		: "No",				// text for the decline/close button (to be used in future releases)
